#let related-work = [
  ...
  #figure( 
      ...
      //[Huang et al.], [Análise de amostras binárias], [Foco pioneiro na análise de mineradores de _Bitcoin_.], [Restrito ao formato binário clássico.], 
      //[Eskandari et al.], [Análise de bibliotecas JS (_Coinhive_)], [Estudo de larga escala sobre proliferação em sites.], [Limitado a mineradores baseados em navegador.], 
      [Meland et al., Papadopoulos et al., Holz et al.], [Avaliação de impacto e custo operacional], [Medição precisa do _overhead_ imposto aos usuários.], [Foco em análise de impacto, não em mecanismos de detecção.], 
      ...
      [Artigo Original de Referência], [Análise estatística de séries temporais com ML], [Agnóstico; 99% de acurácia; analisa ataques furtivos e IoT.], [Exige visibilidade do tráfego no roteador central.], 
      table.hline(stroke: 0.5pt), 
  ), 
  caption: [Comparação dos trabalhos relacionados],
) <tab:trabalhos-relacionados>

  Diferente desses trabalhos, a solução proposta no artigo de referência é a primeira na área de detecção de cryptojacking a analisar diferentes estratégias de lucro do atacante, como por exemplo o uso de _throttling_ para ataques furtivos, e variadas configurações de rede doméstica comprometida, o que afeta diretamente a eficácia da detecção e preenche uma lacuna deixada pelos estudos anteriores.
