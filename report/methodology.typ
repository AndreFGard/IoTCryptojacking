...
- Quais foram os dados usados para avaliar o sistema proposto?
- Por que eles foram escolhidos? O que eles representam?

== Preprocessamento

- Como os conjuntos de treino, validação e teste foram formados?
- Há quantos dados em cada classe nos conjuntos de treino, validação e teste?
